    ...
    async def _execute_login(self) -> bool:
        try:
            ...
            if submit_selector:
                ...
                logger.info("文心一言登录表单已提交")
            else:
                logger.warning("文心一言未找到提交按钮")
            
            return True
        except Exception as e:
            logger.error(f"文心一言自动登录失败：{str(e)}")
            return False
